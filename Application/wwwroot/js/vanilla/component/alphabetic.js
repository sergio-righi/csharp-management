...
(function (root, factory) {
    ...
    function Alphabetic(element, options) {
    ...
    Alphabetic.prototype.init = function () {
    ...
    Alphabetic.prototype.destroy = function () {
    ...
    Alphabetic.prototype.setSituation = function (id, active, cls) {
    ...
    Alphabetic.prototype.setHighlight = function (id) {
    ...
    Alphabetic.prototype.moveTo = function (id, duration) {
    ...
    function _buildNav() {
        ...
        this.navigation.className = 'alphabetic';
