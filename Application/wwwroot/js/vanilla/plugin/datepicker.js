...
(function (root, factory) {
    ...
    Datetimepicker.prototype.open = function (value) {
        ...
        if (this.component === Plugin.DATE_TIME) {
        ...
        } else if (this.component === Plugin.DATE) {
        ...
        } else if (this.component === Plugin.TIME) {
        ...
        if (this.component === Plugin.DATE_TIME || this.component === Plugin.DATE) {
    ...
    function _build() {
        ...
        if (this.component === Plugin.DATE_TIME || this.component === Plugin.TIME) {
    ...
    function _config() {
        ...
        if (typeof this.element.dataset.component !== 'undefined') {
            ...
            if (this.element.dataset.component === 'time') {
                ...
                this.component = Plugin.TIME;

            } else if (this.element.dataset.component === 'date') {

                this.component = Plugin.DATE;

            } else {

                this.component = Plugin.DATE_TIME;
            }
        } else {
